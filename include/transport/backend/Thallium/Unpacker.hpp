...
class Unpacker {
    public:
        ...
        static int unpack(Request::Put         **pm,     void *buf, const std::size_t bufsize);
        static int unpack(Request::Get         **gm,     void *buf, const std::size_t bufsize);
        static int unpack(Request::Get2        **gm,     void *buf, const std::size_t bufsize);
        static int unpack(Request::Delete      **dm,     void *buf, const std::size_t bufsize);
        static int unpack(Request::Histogram   **hist,   void *buf, const std::size_t bufsize);
        ...
        static int unpack(Response::Put        **pm,     void *buf, const std::size_t bufsize);
        static int unpack(Response::Get        **gm,     void *buf, const std::size_t bufsize);
        static int unpack(Response::Get2       **gm,     void *buf, const std::size_t bufsize);
        static int unpack(Response::Delete     **dm,     void *buf, const std::size_t bufsize);
        static int unpack(Response::Histogram  **hist,   void *buf, const std::size_t bufsize);
