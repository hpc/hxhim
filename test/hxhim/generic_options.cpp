...
bool fill_options(hxhim_options_t *opts) {
    ...
    return ((hxhim_options_init(opts)                                                      == HXHIM_SUCCESS) &&
            ...
            (hxhim_options_set_packed_alloc_size(opts, 1000)                               == HXHIM_SUCCESS) &&
            (hxhim_options_set_packed_regions(opts, 100)                                   == HXHIM_SUCCESS) &&
            (hxhim_options_set_packed_name(opts, "Packed")                                 == HXHIM_SUCCESS) &&
            (hxhim_options_set_buffers_alloc_size(opts, 1000)                              == HXHIM_SUCCESS) &&
            (hxhim_options_set_buffers_regions(opts, 100)                                  == HXHIM_SUCCESS) &&
            (hxhim_options_set_buffers_name(opts, "Buffers")                               == HXHIM_SUCCESS) &&
            (hxhim_options_set_bulks_default_alloc_size(opts)                              == HXHIM_SUCCESS) &&
            (hxhim_options_set_bulks_regions(opts, 100)                                    == HXHIM_SUCCESS) &&
            (hxhim_options_set_bulks_name(opts, "Bulks")                                   == HXHIM_SUCCESS) &&
            (hxhim_options_set_keys_alloc_size(opts, 1000)                                 == HXHIM_SUCCESS) &&
            (hxhim_options_set_keys_regions(opts, 100)                                     == HXHIM_SUCCESS) &&
            (hxhim_options_set_keys_name(opts, "Keys")                                     == HXHIM_SUCCESS) &&
            (hxhim_options_set_arrays_alloc_size(opts, 1000)                               == HXHIM_SUCCESS) &&
            (hxhim_options_set_arrays_regions(opts, 100)                                   == HXHIM_SUCCESS) &&
            (hxhim_options_set_arrays_name(opts, "Arrays")                                 == HXHIM_SUCCESS) &&
            (hxhim_options_set_requests_alloc_size(opts, 1000)                             == HXHIM_SUCCESS) &&
            (hxhim_options_set_requests_regions(opts, 100)                                 == HXHIM_SUCCESS) &&
            (hxhim_options_set_requests_name(opts, "Requests")                             == HXHIM_SUCCESS) &&
            (hxhim_options_set_responses_alloc_size(opts, 1000)                            == HXHIM_SUCCESS) &&
            (hxhim_options_set_responses_regions(opts, 100)                                == HXHIM_SUCCESS) &&
            (hxhim_options_set_responses_name(opts, "Responses")                           == HXHIM_SUCCESS) &&
            (hxhim_options_set_result_alloc_size(opts, 1000)                               == HXHIM_SUCCESS) &&
            (hxhim_options_set_result_regions(opts, 100)                                   == HXHIM_SUCCESS) &&
            (hxhim_options_set_result_name(opts, "Result")                                 == HXHIM_SUCCESS) &&
            (hxhim_options_set_results_alloc_size(opts, 1000)                              == HXHIM_SUCCESS) &&
            (hxhim_options_set_results_regions(opts, 100)                                  == HXHIM_SUCCESS) &&
